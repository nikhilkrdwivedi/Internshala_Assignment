...
<div class="container">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="row">
			<div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12"><div class="form-group">
    <label>Title*: </label>
    <input type="text"  name="title" class="form-control"placeholder="Web Development,Content Writer...">
  </div>
</div>
			<div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12"><div class="form-group">
    <label>Company*: </label>
    <input type="text"  name="company" class="form-control"placeholder="intershala,codeforcoder..">
  </div></div>
  <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12"><div class="form-group">
    <label >Location*:</label>
    <input type="text" name="location" class="form-control"  placeholder="work from home,Delhi..">
  </div>
 ...
 <input type="text" name="starting_date"  placeholder="Immediately" class="form-control">
			</div>
			<div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12"><div class="form-group">
    <label>Job Type*:</label>
    <input type="text"  name="job_type" class="form-control" placeholder="Part-Time,Full-Time..">
  </div>
</div>
<div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12">
